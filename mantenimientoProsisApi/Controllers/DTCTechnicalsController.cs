...
namespace mantenimientoProsisApi.Controllers
{
    ...
    public class DTCTechnicalsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DTCTechnical>>> GetDTCTechnicians()
        {
            return await _context.DTCTechnicians.ToListAsync();
        }
        ...
        {
            var dTCTechnical = await _context.DTCTechnicians.FindAsync(id);
        ...
        {
            _context.DTCTechnicians.Add(dTCTechnical);
            try
            {
                await _context.SaveChangesAsync();
            }
        ...
        public async Task<ActionResult<DTCTechnical>> DeleteDTCTechnical(string id)
        {
            ...
            _context.DTCTechnicians.Remove(dTCTechnical);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.DTCTechnicians.Any(e => e.ReferenceNum == id);
        }
    }
}
